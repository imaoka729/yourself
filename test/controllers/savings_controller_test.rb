...
class SavingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saving" do
    assert_difference('Saving.count') do
      post savings_url, params: { saving: { account_id: @saving.account_id, income: @saving.income, income_pay_date: @saving.income_pay_date, pay: @saving.pay } }
    end
  ...
  test "should update saving" do
    patch saving_url(@saving), params: { saving: { account_id: @saving.account_id, income: @saving.income, income_pay_date: @saving.income_pay_date, pay: @saving.pay } }
